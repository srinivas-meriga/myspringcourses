...
public class H2SSensorData {
    ...
    public H2SSensorData(String readingId, String deviceId, BigDecimal reading, Timestamp capturedTime, String status) {
        super();
    ...
    public String toString() {
        return "H2SSensorData [readingId=" + readingId + ", deviceId=" + deviceId + ", reading=" + reading
