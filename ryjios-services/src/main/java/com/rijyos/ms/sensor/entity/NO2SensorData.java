...
public class NO2SensorData {
    ...
    public NO2SensorData() {

    }

    public NO2SensorData(String readingId, String deviceId, BigDecimal reading, Timestamp capturedTime, String status) {
        super();
    ...
    public String toString() {
        return "NO2SensorData [readingId=" + readingId + ", deviceId=" + deviceId + ", reading=" + reading
