...
public class PMSensorData {
    ...
    public PMSensorData(String readingId, String deviceId, BigDecimal reading, Timestamp capturedTime, String status) {
        super();
    ...
    public String toString() {
        return "PMSensorData [readingId=" + readingId + ", deviceId=" + deviceId + ", reading=" + reading
