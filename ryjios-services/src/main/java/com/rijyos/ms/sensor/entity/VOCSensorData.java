...
public class VOCSensorData {
    ...
    public VOCSensorData() {

    }

    public VOCSensorData(String readingId, String deviceId, BigDecimal reading, Timestamp capturedTime, String status) {
        super();
    ...
    public String toString() {
        return "VOCSensorData [readingId=" + readingId + ", deviceId=" + deviceId + ", reading=" + reading
