...
public class RHSensorData {
    ...
    public RHSensorData(String readingId, String deviceId, BigDecimal reading, Timestamp capturedTime, String status) {
        super();
    ...
    public String toString() {
        return "RHSensorData [readingId=" + readingId + ", deviceId=" + deviceId + ", reading=" + reading
