...
public class TempSensorData {
    ...
    public TempSensorData(String readingId, String deviceId, BigDecimal reading, Timestamp capturedTime,
            String status) {
        super();
    ...
    public String toString() {
        return "TempSensorData [readingId=" + readingId + ", deviceId=" + deviceId + ", reading=" + reading
