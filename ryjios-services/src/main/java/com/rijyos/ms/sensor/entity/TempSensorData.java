...
public class TempSensorData extends BaseSensorData {
    ...
    public TempSensorData(BigDecimal reading, Timestamp capturedTime, String status) {
        super(reading, capturedTime, status);
        
    }


    public TempSensorData(BigDecimal reading, Timestamp capturedTime, String status, Integer id,
