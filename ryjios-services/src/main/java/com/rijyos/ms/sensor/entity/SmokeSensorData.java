...
public class SmokeSensorData {
    ...
    public SmokeSensorData(String readingId, String deviceId, BigDecimal reading, Timestamp capturedTime, String status) {
        super();
    ...
    public String toString() {
        return "SmokeSensorData [readingId=" + readingId + ", deviceId=" + deviceId + ", reading=" + reading
