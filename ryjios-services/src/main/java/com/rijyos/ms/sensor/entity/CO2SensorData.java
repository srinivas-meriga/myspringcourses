...
public class CO2SensorData {
    ...
    public CO2SensorData(String readingId, String deviceId, BigDecimal reading, Timestamp capturedTime, String status) {
        super();
    ...
    public String toString() {
        return "CO2SensorData [readingId=" + readingId + ", deviceId=" + deviceId + ", reading=" + reading
