...
public class NO2SensorData extends BaseSensorData {
    ...
    public NO2SensorData(BigDecimal reading, Timestamp capturedTime, String status) {
        super(reading, capturedTime, status);
        
    }


    public NO2SensorData(BigDecimal reading, Timestamp capturedTime, String status, Integer id,
