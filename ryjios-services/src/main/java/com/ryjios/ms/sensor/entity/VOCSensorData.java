...
public class VOCSensorData extends BaseSensorData {
    ...
    public VOCSensorData(BigDecimal reading, Timestamp capturedTime, String status) {
        super(reading, capturedTime, status);
        
    }


    public VOCSensorData(BigDecimal reading, Timestamp capturedTime, String status, Integer id,
